...
public:
	...
	virtual void add_texture(int id, const uint8_t* data, int width, int height) = 0;
	...
	virtual void draw_render_command(const render_command& render_command, int texture_id) = 0;
};
}  // namespace lib::rendering