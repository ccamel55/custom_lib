...
const static auto pin_offset = lib::point2Di(10, title_size_y / 2);
const static auto pin_size = lib::point2Di(6, 6);

const static auto contents_start_offset = lib::point2Di(border_size, title_size_y);
const static auto contents_end_offset = lib::point2Di(border_size * 2, title_size_y + border_size);
