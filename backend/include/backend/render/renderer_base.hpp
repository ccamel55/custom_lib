...
namespace lib::backend
{
	...
	public:
		...
		//! draw a string
		virtual void draw_string(common::fnv1a_t font_hash, const common::point2Di& pos, const common::color& color, const std::string& string, render_flags flags) = 0;

		//! draw a rectangle
		virtual void draw_rect(const common::point4Di& area, const common::color& color, render_flags flags) = 0;

		//! draw a gradient rectangle
		virtual void draw_rect_gradient(const common::point4Di& area, const common::color& color1, const common::color& color2, render_flags flags) = 0;
		...
		virtual void draw_rect_filled_gradient(const common::point4Di& area, const common::color& color1, const common::color& color2, render_flags flags) = 0;

		//! draw a circle
		virtual void draw_circle(const common::point2Di& pos, float radius, const common::color& color, render_flags flags) = 0;

		//! draw a filled circle
		virtual void draw_circle_filled(const common::point2Di& pos, float radius, const common::color& color, render_flags flags) = 0;

		//! draw a filled gradient circle
		virtual void draw_circle_filled_gradient(const common::point2Di& pos, float radius, const common::color& color1, const common::color& color2, render_flags flags) = 0;

		//! draw a triangle
		virtual void draw_triangle(const common::point2Di& pos1, const common::point2Di& pos2, const common::point2Di& pos3, const common::color& color, render_flags flags) = 0;
