...
backend_window::backend_window(std::string_view window_name, int pos_x, int pos_y, int width, int height, WINDOW_FLAGS_E flags)
    : backend_window_base(window_name, pos_x, pos_y, width, height, flags) {
...
void backend_window::create_window() {
