...
namespace lib
{
	...
	inline t GET_VIRTUAL_FN(void* class_ptr, size_t index)
	{
	...
	inline t CALL_VIRTUAL_FN(void* class_ptr, size_t index, a... args)
	{
	...
	template <typename t, typename ... a>
	inline t CALL_FN(void* ecx, uintptr_t fn_address, a... args)
	{
		using fn_sig = t(__thiscall*)(void*, decltype(args)...);
